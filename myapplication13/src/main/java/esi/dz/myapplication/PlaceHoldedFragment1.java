...
/**
 * Created by pc on 31/03/2016.
 */
public class PlaceHoldedFragment1 extends Fragment {
    ListView    listView ;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       DrawerLayout drawerLayout = (DrawerLayout) getActivity().findViewById(R.id.drawer_layout);
        ...
        CutomAdapter  cutomAdapter = new CutomAdapter(getActivity(),getBookList("Genie logiciel"));
